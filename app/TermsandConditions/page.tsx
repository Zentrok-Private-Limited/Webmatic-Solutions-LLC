    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <section className="max-w-4xl mx-auto px-6 py-16">
        <div className="bg-white p-8 md:p-12 rounded-2xl border border-slate-100 shadow-sm space-y-8 text-slate-600 leading-relaxed">
          ...
          {/* Section 1 */}
          <div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">1. OUR SERVICES</h3>
            <p>
          ...
          {/* Section 2 */}
          <div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">2. INTELLECTUAL PROPERTY RIGHTS</h3>
            <p className="font-semibold text-slate-800">Our intellectual property</p>
            <p className="mt-2">
            ...
            <p className="font-semibold text-slate-800 mt-6">Your use of our Services</p>
            <p className="mt-2">
            ...
            <p className="font-semibold text-slate-800 mt-6">Your submissions</p>
            <p className="mt-2">
          ...
          {/* Section 3 */}
          <div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">3. USER REPRESENTATIONS</h3>
            <p>
          ...
          {/* Section 4 */}
          <div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">4. PROHIBITED ACTIVITIES</h3>
            <p>
          ...
          {/* Section 5 */}
          <div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">5. USER GENERATED CONTRIBUTIONS</h3>
          ...
          {/* Section 6 */}
          <div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">6. CONTRIBUTION LICENSE</h3>
            <p>
          ...
          {/* Section 7 */}
          <div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">7. SERVICES MANAGEMENT</h3>
            <p>
          ...
          {/* Section 9 */}
          <div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">9. TERM AND TERMINATION</h3>
            <p>
          ...
          {/* Section 10 */}
          <div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">10. MODIFICATIONS AND INTERRUPTIONS</h3>
            <p>
          ...
          {/* Section 11 */}
          <div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">11. GOVERNING LAW</h3>
            <p>
          ...
          <div>
            ...
            <p className="font-semibold text-slate-800 mt-6">Exceptions to Arbitration</p>
            <p className="mt-2">
          ...
          {/* Section 13 */}
          <div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">13. CORRECTIONS</h3>
            <p>
          ...
          {/* Section 14 */}
          <div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">14. DISCLAIMER</h3>
            <p className="uppercase text-xs font-semibold text-slate-500">
          ...
          {/* Section 15 */}
          <div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">15. LIMITATIONS OF LIABILITY</h3>
            <p className="uppercase text-xs font-semibold text-slate-500">
          ...
          {/* Section 16 */}
          <div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">16. INDEMNIFICATION</h3>
            <p>
          ...
          {/* Section 17 */}
          <div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">17. USER DATA</h3>
            <p>
          ...
          {/* Section 18 */}
          <div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">18. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h3>
            <p>
          ...
          {/* Section 19 */}
          <div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">19. CALIFORNIA USERS AND RESIDENTS</h3>
            <p>
          ...
          {/* Section 21 */}
          <div>
            <h3 className="text-xl font-bold text-slate-900 mb-3">21. CONTACT US</h3>
            <p>
